...
INFO_LINK = '/'.join([BASE_LINK, 'en/show/news'])
MOVIES_LINK = '/'.join([BASE_LINK, 'en/show/movies'])
DOCUMENTARIES_LINK = '/'.join([BASE_LINK, 'en/show/documentary'])
SERIES_LINK = '/'.join([BASE_LINK, 'en/show/series'])
SHOWS_LINK = '/'.join([BASE_LINK, 'en/show/ekpompes'])
SPORTS_LINK = '/'.join([BASE_LINK, 'en/show/sport'])
ARCHIVE_LINK = '/'.join([BASE_LINK, 'en/show/archives'])
KIDS_LINK = '/'.join([BASE_LINK, 'en/show/children'])
